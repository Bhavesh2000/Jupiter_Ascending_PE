    ...
    public partial class AddedAllTheTablesToDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SkillTrainer", x => new { x.SkillsId, x.TrainersId });
                    table.ForeignKey(
                        name: "FK_SkillTrainer_Skills_SkillsId",
                        column: x => x.SkillsId,
                        principalTable: "Skills",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SkillTrainer_Trainers_TrainersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SkillTrainer_TrainersId",
                table: "SkillTrainer",
                column: "TrainersId");
        }
